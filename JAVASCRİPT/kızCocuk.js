...
document.addEventListener('DOMContentLoaded', function () {
    const kutu = document.querySelector('.bildirimKUTU');
    const basarili = document.querySelector('.basarili-1');
    const basarisiz = document.querySelector('.basarisiz-1');


    if (kutu) {
        if (basarili?.textContent.trim()) {
            basarili.style.display = 'block';
            if (basarisiz) basarisiz.style.display = 'none';
            kutu.classList.add('show');
            setTimeout(function () {
                kutu.classList.remove('show');
                basarisiz.style.display = 'none';
            }, 3000);
        }
        else if (basarisiz?.textContent.trim()) {
            basarisiz.style.display = 'block';
            if (basarili) basarili.style.display = 'none';
            kutu.classList.add('show');
            setTimeout(function () {
                kutu.classList.remove('show');
                basarisiz.style.display = 'none';
...
//     bildirimGoster(`${urun.isim} Sepete Eklendi`, 'basarili');
